...
public class AccountDAO {
    ...
    public boolean doesAccountExist(String mobileNumber) {
        try (Connection conn = dataSource.getConnection();
             PreparedStatement preparedStatement = conn.prepareStatement(AppConstants.ACCOUNT_CHECK_SQL)) {
    ...
    public void createAccount(UserAccount userAccount) {
        try (Connection conn = dataSource.getConnection();
             PreparedStatement preparedStatement = conn.prepareStatement(AppConstants.CREATE_ACCOUNT_SQL)) {
